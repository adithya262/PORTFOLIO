...
const Footer = () => {
  ...
  return (
    <footer className="relative bottom-0 left-0 w-full bg-bg-primary-dark text-white/70 py-4 z-40">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-4 relative">
        {/* Copyright */}
        <div 
          className="mb-3 md:mb-0 text-xs font-inter text-cyan-400/80 cursor-pointer"
        ...
        <AnimatePresence>
          {showMessage && (
            <motion.div
              ...
              className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-pink-500/20 border border-pink-500/50 rounded-lg shadow-lg shadow-pink-500/20"
            >
              <p className="text-base font-semibold text-pink-300">I love you Rakshu baby ❤️</p>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div className="flex space-x-5">
          <a href="mailto:prasannaaditya2603@gmail.com" className="text-white/70 hover:text-neon-purple transition-colors duration-300 group">
            <Mail size={18} className="group-hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.7)]" />
          </a>
          <a href="https://www.linkedin.com/in/prasanna-aditya-prabakaran-az26112003/" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-neon-purple transition-colors duration-300 group">
            <Linkedin size={18} className="group-hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.7)]" />
          </a>
          <a href="https://www.instagram.com/_aditya_2603/" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-neon-purple transition-colors duration-300 group">
            <Instagram size={18} className="group-hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.7)]" />
          </a>
          <a href="https://github.com/adithya262" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-neon-purple transition-colors duration-300 group">
            <Github size={18} className="group-hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.7)]" />
          </a>
        </div>
      </div>
    </footer>
